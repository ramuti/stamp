...
#updateStatus { margin-left:8px; font-weight:bold; }
</style>
</head>
<body class="user">
...
<div style="margin-top:12px;">
  <button onclick="checkUpdateJS()">update.js 再読み込み</button>
  <span id="updateStatus">読み込みチェック中…</span>
</div>

<!-- update.js を読み込む -->
<script>
function loadUpdateJS(){
...
async function checkUpdateJS(){
  const statusDiv = document.getElementById("updateStatus");
  try{
    await loadUpdateJS();
    statusDiv.textContent = "update.js 読み込まれました！ ✅";
  }catch(e){
    statusDiv.textContent = "update.js 読み込まれてません ❌";
  }
}
